    ...
    <table style="width: 96%;margin: auto;border: 0px;" class="needToDisPlay">
        ...
        <c:forEach var="myShoppingCarFood" items="${myShoppingCarFoodList }">
            <tr>
                ...
                <td style="text-align: center;"><a class="operatecar" data-operate='-1'
                                                   data-operateid='${myShoppingCarFood.id}'
                                                   style="text-decoration: none" href="javascript:void(0)">-</a></td>
