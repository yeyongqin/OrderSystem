    ...
    <div class="w main">
        ...
        <form id="frm_login" method="post" action="../user/doUserLogin">
            <div class="item item-username">
                <input name="phone" id="username" class="txt-input txt-username" type="text"
                       placeholder="请输入手机号" value="">
                <b class="input-close" style="display: none;"></b>
            </div>
            <div class="item item-password">
                <input name="userPassword" id="password" class="txt-input txt-password ciphertext" type="password"
                       placeholder="请输入密码" style="display: inline;">
            ...
            <div class="item item-login-other">
                <dl>
                    <dt>其它登录方式</dt>
                    <dd>
                        <a class="qq" href="javascript:void(0)"> <span><img alt="" src="../images/login_qq.png"
