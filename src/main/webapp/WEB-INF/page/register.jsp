    ...
    <div class="w main">
        <form id="frm_login" method="post">
            ...
            <div class="item item-username">
                <input id="username" class="txt-input txt-username" type="text" placeholder="请输入手机号" name="username">
                <b class="input-close" style="display: none;"></b>
            </div>

            <div class="item item-password">
                <input id="password" class="txt-input txt-password ciphertext" type="password" placeholder="请设置密码"
            ...
            <div class="item item-password">
                <input id="password_PwdTwo" class="txt-input txt-password_PwdTwo ciphertext_PwdTwo" type="password"
                       placeholder="请再次输入密码" name="password_PwdTwo" style="display: inline;">
                <input id="ptext_PwdTwo" class="txt-input txt-password_PwdTwo plaintext_PwdTwo" type="text"
                       placeholder="请再次输入密码" style="display: none;" name="ptext_PwdTwo">
                <b class="tp-btn_PwdTwo btn-off_PwdTwo"></b>
            </div>

            <div class="item item-name">
                <input id="name" class="txt-input txt-name" type="text" placeholder="请输入姓名" name="name">
                <b class="input-close" style="display: none;"></b>
            </div>

            <div class="item item-captcha">
                <div class="input-info">
                    <input id="validateCode" name="validateCode" class="txt-input txt-captcha" type="text"
                           placeholder="验证码" autocomplete="off" maxlength="6" size="11">
            ...
            <div class="ui-btn-wrap">
                <a id="userRegister" class="ui-btn-lg ui-btn-primary" href="javascript:void(0)">注册</a>
            </div>

            <div class="ui-btn-wrap">
                <a class="ui-btn-lg ui-btn-danger" href="/user/toUserLogin">已有账号？立即登录</a>
            </div>
...
<script type="text/javascript">
    ...
    function displayClearBtn() {
        if (document.getElementById("phone").value != '') {
            $("#phone").siblings(".input-close").show();
        }
